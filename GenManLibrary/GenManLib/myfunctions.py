...
#Module - file of python code that contains definitions, such as functions, classes and variables
#Library - A collection of related modules packaged together to provide specific functionality
